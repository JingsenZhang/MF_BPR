...
if __name__=='__main__':
    ...
    os.system( 'python GMF.py --lr 0.001 --batch_size=256 --epochs 25 --top_k 10 --embedding_dim 8 --num_ng 4 --data_set ml-1m --out True ')
    os.system('python MLP.py --lr 0.001 --batch_size=256 --epochs 25 --top_k 10 --embedding_dim 32 --num_ng 4 --data_set ml-1m --out True ')
    os.system('python NeuMF.py --lr 0.001 --batch_size=256 --epochs 50 --top_k 10 --use_pretrained --embedding_dim_GMF 8 --embedding_dim_MLP 32 --hidden_layer_MLP 32 16 8 --num_ng 4 --data_set ml-1m --out True ')
    #使用预训练的neumf,记得更改图片名
