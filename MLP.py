...
if __name__=="__main__":
    ...
    timestamp = time.time()
    run_id = "%.2f" % (timestamp)
    log_dir='result/MLP_log/'+run_id+'.log'
    log_error_dir = 'result/MLP_log/' +run_id+'error.log'
    ...
    for epoch in range(args.epochs):
        ...
        print("MLP Epoch: {}, loss: {}, HR: {:.3f}, NDCG: {:.3f}".format(epoch + 1, round(loss.item(), 5), hr, ndcg))
    ...
    utils.result_plot(HR_list, 'Testing', 'Epochs', 'HR', "result/MLP_HR.jpg")
    utils.result_plot(NDCG_list, 'Testing', 'Epochs', 'NDCG', "result/MLP_NDCG.jpg")
    print("MLP End")
